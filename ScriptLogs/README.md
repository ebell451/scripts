The Gather.bat script uses the following SysInternal files that will need to be downloaded from https://docs.microsoft.com/en-us/sysinternals/downloads/ and placed in the same folder as the script:
